 ...
 *
    ...
    Functional Programming Approach. Data is in file ./TestMhtnDefaults.js
        name of data is 'testMhtnDefaults'.
 ...
 To Do:
            ...
            Should we have the Standard Deviation per scaffold, 
                or should we have the z-score  for all insertions 
...
function CreateMhtnDisplay(testMhtnDefaults, c_info, c_data) {
        /*
         *
         * Args:
         *     testMhtnDefaults:
    ...
    CreateGraphDisplay(testMhtnDefaults, c_info, c_data);
    CreateExplainDisplayDiv(testMhtnDefaults, c_info);
    PopulateElements(c_data, testMhtnDefaults);
}

function PopulateElements(c_data, testMhtnDefaults) {
    /*
    ...
    let svg_d3 = d3.select("#" + testMhtnDefaults["lyt_vls"]["graph_svg"]["id_i"]["id"]);
    let scaffolds_info_and_maxSD = OrderScaffoldNamesAndLengths(c_data, svg_d3); 
    ...
    let scf_to_color_obj = CreateScaffoldToColorMap(scf_names_and_lengths, testMhtnDefaults)

    PopulateScaffoldInfoTable(testMhtnDefaults, scf_names_and_lengths, scf_to_color_obj, svg_d3, max_z);

    PopulateGraphSVG(testMhtnDefaults, c_info, c_data, scf_names_and_lengths, max_z, scf_to_color_obj)



}

function CreateScaffoldToColorMap(scf_names_and_lengths, testMhtnDefaults) {

    let scf_to_color_obj = {};
    let color_list = testMhtnDefaults["Scaffold_Info_Table_Values"]["color_options"];
...
function PopulateScaffoldInfoTable(testMhtnDefaults, scf_names_and_lengths, scf_to_color_obj, svg_d3, max_z) {
    /*
     *
     * Args:
     *      testMhtnDefaults: The giant Default data object passed in
    ...
    // We get the table
    let tbl = document.getElementById(testMhtnDefaults["lyt_vls"]["scfld_list_tbl"]["id_i"]["id"]);
    ...
    for (let r = sc_l.length-1; r >= 0; r--) {
            ...
            scf_link.onclick = function() {
                MakeSingleScaffoldGraph(scf_name, c_data, scf_to_color_obj, sc_l, max_z )
            }
...
function CreateGraphDisplay(testMhtnDefaults, c_info, c_data) {
    let graph_display_elem = LUCreateElementFromInfo(
            testMhtnDefaults["lyt_vls"]["graph_display_div_i"]);
    CreateGraphAndTitleDiv(testMhtnDefaults, c_info)
    CreateInfoSideBar(testMhtnDefaults, c_info, c_data)
}

function CreateGraphAndTitleDiv(testMhtnDefaults, c_info) {

    let graph_and_title_div_elem = LUCreateElementFromInfo(
            testMhtnDefaults["lyt_vls"]["graph_and_title_div"]);
    CreateGraphTitleDiv(testMhtnDefaults, c_info)
    CreateGraphSVGDiv(testMhtnDefaults, c_info, c_data)

}

function CreateGraphTitleDiv(testMhtnDefaults, c_info) {

    let graph_title_elem = LUCreateElementFromInfo(
            testMhtnDefaults["lyt_vls"]["graph_title_div"]);
    graph_title_elem.innerHTML = testMhtnDefaults["lyt_vls"]["graph_title_div"]["graph_title"]
}

function CreateGraphSVGDiv(testMhtnDefaults, c_info, c_data) {

    let graph_svg_div_elem = LUCreateElementFromInfo(
            testMhtnDefaults["lyt_vls"]["graph_svg_div"]);
    CreateGraphSVG(testMhtnDefaults, c_info, c_data);
}

function CreateGraphSVG(testMhtnDefaults, c_info, c_data) {
    svg_info = testMhtnDefaults["lyt_vls"]["graph_svg"];
...
function CreateInfoSideBar(testMhtnDefaults, c_info, c_data) {
    let info_side_bar = LUCreateElementFromInfo(
            testMhtnDefaults["lyt_vls"]["graph_info_sidebar"]);
    CreatePointInfoDiv(testMhtnDefaults, c_info, c_data);
    CreateScaffoldListDiv(testMhtnDefaults, c_info, c_data);
    CreateAllScaffoldsViewButton(testMhtnDefaults, c_info, c_data);
}

function CreatePointInfoDiv(testMhtnDefaults, c_info, c_data) {
    let point_info_div = LUCreateElementFromInfo(
            testMhtnDefaults["lyt_vls"]["point_info_div"]);
    CreatePointInfoTitle(testMhtnDefaults, c_info, c_data);
    CreateInfoScrollDownText(testMhtnDefaults, c_info, c_data);
}

function CreatePointInfoTitle(testMhtnDefaults, c_info, c_data) {

    let point_info_div = LUCreateElementFromInfo(
            testMhtnDefaults["lyt_vls"]["point_info_ttl_div"]);
    point_info_div.innerHTML = "Point Info:"

}

function CreateInfoScrollDownText(testMhtnDefaults, c_info, c_data) {
    
    let point_info_scrldwn_div = LUCreateElementFromInfo(
            testMhtnDefaults["lyt_vls"]["point_info_scrldwn_div"]);

}

function CreateScaffoldListDiv(testMhtnDefaults, c_info, c_data) {

    let scfld_list_div = LUCreateElementFromInfo(
            testMhtnDefaults["lyt_vls"]["scfld_list_div"]);
    CreateScaffoldsListTitle(testMhtnDefaults, c_info, c_data);
    CreateScaffoldListScrollDown(testMhtnDefaults, c_info, c_data);
}

function CreateScaffoldsListTitle(testMhtnDefaults, c_info, c_data) {
    let scfld_list_ttl_div = LUCreateElementFromInfo(
            testMhtnDefaults["lyt_vls"]["scfld_list_ttl_div"]);
    scfld_list_ttl_div.innerHTML = "Scaffolds:"
}

function CreateScaffoldListScrollDown(testMhtnDefaults, c_info, c_data) {

    let scfld_list_scrldwn_div = LUCreateElementFromInfo(
            testMhtnDefaults["lyt_vls"]["scfld_list_scrldwn_div"]);

    // The below function creates a table in some location 
    CreateScaffoldInfoTable(testMhtnDefaults) 
}

function CreateAllScaffoldsViewButton(testMhtnDefaults, c_info, c_data) {

    let scfld_list_scrldwn_div = LUCreateElementFromInfo(
            testMhtnDefaults["lyt_vls"]["all_scaffolds_btn_div"]);

}

function CreateExplainDisplayDiv(testMhtnDefaults, c_info) {
    let explain_display_div = LUCreateElementFromInfo(
            testMhtnDefaults["lyt_vls"]["explanation_div"]);
    explain_display_div.innerHTML = testMhtnDefaults["lyt_vls"]["explanation_div"]["explain_text"].join("");
}

function CreateExplainText(testMhtnDefaults, c_info) {

}

function PopulateGraphSVG(testMhtnDefaults, c_info, c_data, scf_names_and_lengths, max_z, scf_to_color_obj) {
    // This is the most complex function in the program
    MakeAllScaffoldsGraph(c_data, testMhtnDefaults, scf_names_and_lengths, max_z, scf_to_color_obj);
}


function GetDefaultVariables() {
        x_i = testMhtnDefaults["x_i"];
        y_i = testMhtnDefaults["y_i"];
}
...
function MakeAllScaffoldsGraph(c_data, testMhtnDefaults, scf_names_and_lengths, max_z, scf_to_color_obj) {
    /*
     * c_data: The entire data for the scaffolds etc.
     * testMhtnDefaults: imported from TestMhtnDefaults.js
     *
        // scfld_length_array: list<[scaffold_name (str), scaffold_length (int), scaffold_start (int)]>
     *
        // max_z_for_all_scf: Number: the total max Z-Score
    ...
    // Change c_info to c_data
    //

        // Clear old SVG
        let svg_obj = document.getElementById(testMhtnDefaults["lyt_vls"]["graph_svg"]["id_i"]["id"]);
        ...
        let x_i = testMhtnDefaults["Mhtn_Display_SVG_Values"]["x_i"];
        let y_i = testMhtnDefaults["Mhtn_Display_SVG_Values"]["y_i"];
        let org = testMhtnDefaults["Mhtn_Display_SVG_Values"]["org"];
        let svg_i = {
        ...
        let max_crc_r = svg_i["width"]*testMhtnDefaults[
                                    "Mhtn_Display_SVG_Values"]["GraphValues"]["max_circle_frac"];
        let min_crc_r = svg_i["width"]*testMhtnDefaults[
...
function AddReturnButton(scf_names_and_lengths, max_z, scf_to_color_obj) {
        ...
        if (!rtn_btn) {
            ...
            let rb_d = testMhtnDefaults["lyt_vls"]["all_scf_btn"];
            ...
            return_btn_obj.onclick = function() {MakeAllScaffoldsGraph(
                    c_data, testMhtnDefaults, scf_names_and_lengths, max_z, scf_to_color_obj
                    )};
            /*
...
function PopulateManhattanSkyline(scf_names_and_lengths, scfs_info, graph_info,
    ...
    for ( i=0; i < scf_names_and_lengths.length; i++) {
        ...
        if (c_data["analysis_type"] == "AllGenomeStats") {
            new_scf_i_d["mean"] = c_data["mean"];
            new_scf_i_d["SD"] = c_data["SD"];
            new_scf_i_d["max_z"] = c_data["max_z"];
        }
...
function UpdatePointInfo(point_info_array, scaffold_name, new_scf_i_d) {
    ...
    pos_obj = document.getElementById(testMhtnDefaults[
...
function GetSortedScaffoldNamesAndLengths(c_data) {
    /*
    ...
    let scfld_info_d = c_data["scaffolds"]
...
function CreateScaffoldInfoTable(testMhtnDefaults) {
    ...
    let scf_tbl_obj = LUCreateElementFromInfo(testMhtnDefaults["lyt_vls"]["scfld_list_tbl"]);
    let scf_tbl_entries_i = testMhtnDefaults["Scaffold_Info_Table_Values"]["entry_size_info"];
}
...
//NOW
function MakeSingleScaffoldGraph(scf_name, c_data, scf_to_color_obj, scf_names_and_lengths, max_z) {
    ...
    */
    ...
    let current_scf_info_d = c_data["scaffolds"][scf_name]
